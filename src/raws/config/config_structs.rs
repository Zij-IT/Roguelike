...
impl From<VirtualKeyCodeDef> for VirtualKeyCode {
    fn from(vlc: VirtualKeyCodeDef) -> Self {
        match vlc {
            ...
            VirtualKeyCodeDef::Add => Self::Add,
            ...
            VirtualKeyCodeDef::Decimal => Self::Decimal,
            VirtualKeyCodeDef::Divide => Self::Divide,
            ...
            VirtualKeyCodeDef::Multiply => Self::Multiply,
            ...
            VirtualKeyCodeDef::Subtract => Self::Subtract,
